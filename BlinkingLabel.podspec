...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yirumi-simba/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yirumi-simba' => 'zouwanyu@jianyigp.com' }
  s.source           = { :git => 'https://github.com/yirumi-simba/BlinkingLabel.git', :tag => s.version.to_s }
